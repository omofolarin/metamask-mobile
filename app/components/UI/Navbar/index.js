 ...
 */
export function getNetworkNavbarOptions(title, translate, navigation, themeColors, onRightPress = undefined) {
	const innerStyles = StyleSheet.create({
		headerStyle: {
			backgroundColor: themeColors.background.default,
			shadowColor: importedColors.transparent,
	...
	return {
		...
		headerRight: onRightPress
			? () => (
					<TouchableOpacity onPress={onRightPress} style={styles.backButton} testID={'asset-back-button'}>
